  ...
  return (
    <div className='w-full'>
        <div className='w-full h-auto '>
            <header className='w-full h-20 bg-white shadow-[0px_2px_5px_rgba(12,12,13,0.2)] flex items-center justify-between px-6 lg:px-20 '>
                ...
                <div className='max-w-[1200px] w-full h-auto px-4 m-auto'>
                    <div className='w-full h-auto md:h-[650px] md:flex py-8 md:py-0'>
                        <div className='w-full md:w-1/2 h-full px-2 flex justify-center items-center'>
                            <div>
                                <h1 className='text-4xl text-gray-700 sm:text-5xl font-semibold sm:leading-15 break-words '>Manage Tasks,<br />Collaborate with Teams</h1>
                        ...
                        <div className='w-full h-auto py-14 px-2'>
                            <div className='w-full flex justify-center'>
                                <div className='w-full md:w-[75%] px-4 text-center'>
                                    <h2 className=' text-3xl text-gray-700 sm:text-4xl font-semibold break-words '>Key features</h2>
                            ...
                            <div className='w-full pt-10 mt-6 flex flex-wrap gap-6'>
                                <div className=' max-w-[360px] w-full h-[380px] rounded-2xl p-4 flex justify-center items-center bg-white border-[1px] border-gray-300 hover:shadow-[0px_0px_15px_rgba(0,0,0,0.2)] '>
                                    <div className='w-auto h-auto'>
                                        ...
                                        <div className='w-full mt-4'>
                                            <h1 className='text-2xl text-gray-700 font-semibold '>Task Management</h1>
                                ...
                                <div className=' max-w-[360px] w-full h-[380px] rounded-2xl p-4 flex justify-center items-center bg-white border-[1px] border-gray-300 '>
                                    <div className='w-auto h-auto'>
                                        ...
                                        <div className='w-full mt-4'>
                                            <h1 className='text-2xl text-gray-700 font-semibold '>Team Collaboration</h1>
                                ...
                                <div className=' max-w-[360px] w-full h-[380px] rounded-2xl p-4 flex justify-center items-center bg-white border-[1px] border-gray-300 '>
                                    <div className='w-auto h-auto'>
                                        ...
                                        <div className='w-full mt-4'>
                                            <h1 className='text-2xl text-gray-700 font-semibold '>Workspaces</h1>
                                ...
                                <div className=' max-w-[360px] w-full h-[380px] rounded-2xl p-4 flex justify-center items-center bg-white border-[1px] border-gray-300 '>
                                    <div className='w-auto h-auto'>
                                        ...
                                        <div className='w-full mt-4'>
                                            <h1 className='text-2xl text-gray-700 font-semibold '>Integrated Communication</h1>
                                ...
                                <div className=' max-w-[360px] w-full h-[380px] rounded-2xl p-4 flex justify-center items-center bg-white border-[1px] border-gray-300 '>
                                    <div className='w-auto h-auto'>
                                        ...
                                        <div className='w-full mt-4'>
                                            <h1 className='text-2xl text-gray-700 font-semibold '>Progress Tracking</h1>
                ...
                <div className='w-full '>
                    <div className='max-w-[1200px] w-full h-auto px-4 m-auto'>
                        <div className='w-full h-auto py-16 px-2'>
                            <div className='w-full flex justify-center'>
                                <div className='w-full md:w-[75%] px-4 text-center'>
                                    <h2 className=' text-3xl sm:text-4xl text-gray-700 font-semibold break-words '>How Trelloop works</h2>
                                    <h4 className='text-gray-500 sm:text-lg mt-4 break-words  '>
                            ...
                            <div className='w-full pt-8'>
                                <div className='w-full my-14 flex'>
                                    ...
                                    <div className='w-full flex flex-col justify-center'>
                                        <h1 className='text-3xl text-gray-700 font-semibold '>Create Your Workspace</h1>
                                ...
                                <div className='w-full my-14 flex'>
                                    <div className='w-full flex flex-col justify-center'>
                                        <h1 className='text-3xl text-gray-700 font-semibold '>Manage Tasks & Projects</h1>
                                ...
                                <div className='w-full my-14 flex'>
                                    ...
                                    <div className='w-full flex flex-col justify-center'>
                                        <h1 className='text-3xl text-gray-700 font-semibold '>Collaborate & Communicate</h1>
                                ...
                                <div className='w-full mt-14 flex'>
                                    <div className='w-full flex flex-col justify-center'>
                                        <h1 className='text-3xl text-gray-700 font-semibold '>Track & Optimize</h1>
                        ...
                        <div className='w-full h-full py-24 flex justify-center items-center'>
                            <div className='w-full md:w-[65%]'>
                                <div className='w-full text-center'>
                                    <h1 className='text-3xl text-gray-700 sm:text-4xl font-semibold break-words '>Ready to transform your team’s work</h1>
                                ...
                                <div className='w-full h-auto mt-12 flex justify-center '>
                                    <div className='w-auto h-auto flex'>
                                        ...
                                        className='border-none outline-none hidden sm:block max-w-[400px] px-4 py-1 text-gray-700 text-lg md:text-xl rounded-xl bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.3)]' />
                                        <div>
